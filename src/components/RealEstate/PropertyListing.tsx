...
Thank you.
  ...
  // Contact form component to reuse in both places
  const ContactForm = () => (
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Image gallery */}
          <div className="relative rounded-lg overflow-hidden bg-gray-200 h-[200px] lg:h-[400px]">
            <img
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-800">
                    Near Tahasildar Office, Hatkanangale
                  </p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {propertyArea} - {builtUpArea} Sq.Ft
                  </p>
                </div>
                <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden z-10">
        <button
          ...
          className="w-full bg-blue-600 text-white py-4 font-medium text-lg shadow-lg">
          Enquire Now
        </button>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 lg:hidden">
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold">Get call back</h3>
              <button
