          ...
          <div className="flex flex-col lg:flex-row justify-between w-full">
            <div className="w-full lg:w-4/5 flex flex-col gap-4">
              ...
              <div className="text-white max-w-xs">
                ...
                builders in Kolhapur, and it is known for spearheading numerous
            ...
            <div className="flex flex-col lg:flex-row w-full gap-4 justify-evenly lg:gap-10">
              <div className="lg:w-full pt-4 flex flex-col gap-4">
                ...
                <div className="text-white max-w-xs">
                  Business Bay Building, Avishkar Infra, Tarabai Park, Kolhapur
                </div>
                <div className="text-white max-w-xs">
              ...
              <div className="lg:w-1/3 pt-4 flex flex-col justify-start items-start gap-4">
                <div className="text-white font-semibold text-xl">Social</div>
                <Link href={"/about"} className="text-white max-w-xs">
                  About us
                </Link>
                <Link href={"/projects"} className="text-white max-w-xs">
...
<path d="M31 15C31.5304 15 32.0391 15.2107 32.4142 15.5858C32.7893 15.9609 33 16.4696 33 17V31C33 31.5304 32.7893 32.0391 32.4142 32.4142C32.0391 32.7893 31.5304 33 31 33H17C16.4696 33 15.9609 32.7893 15.5858 32.4142C15.2107 32.0391 15 31.5304 15 31V17C15 16.4696 15.2107 15.9609 15.5858 15.5858C15.9609 15.2107 16.4696 15 17 15H31ZM30.5 30.5V25.2C30.5 24.3354 30.1565 23.5062 29.5452 22.8948C28.9338 22.2835 28.1046 21.94 27.24 21.94C26.39 21.94 25.4 22.46 24.92 23.24V22.13H22.13V30.5H24.92V25.57C24.92 24.8 25.54 24.17 26.31 24.17C26.6813 24.17 27.0374 24.3175 27.2999 24.5801C27.5625 24.8426 27.71 25.1987 27.71 25.57V30.5H30.5ZM18.88 20.56C19.3256 20.56 19.7529 20.383 20.0679 20.0679C20.383 19.7529 20.56 19.3256 20.56 18.88C20.56 17.95 19.81 17.19 18.88 17.19C18.4318 17.19 18.0019 17.3681 17.685 17.685C17.3681 18.0019 17.19 18.4318 17.19 18.88C17.19 19.81 17.95 20.56 18.88 20.56ZM20.27 30.5V22.13H17.5V30.5H20.27Z" fill="#213123"/>
                    ...
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="48" height="48" rx="24" fill="white"/>
<path d="M34.46 18C33.69 18.35 32.86 18.58 32 18.69C32.88 18.16 33.56 17.32 33.88 16.31C33.05 16.81 32.13 17.16 31.16 17.36C30.37 16.5 29.26 16 28 16C25.65 16 23.73 17.92 23.73 20.29C23.73 20.63 23.77 20.96 23.84 21.27C20.28 21.09 17.11 19.38 15 16.79C14.63 17.42 14.42 18.16 14.42 18.94C14.42 20.43 15.17 21.75 16.33 22.5C15.62 22.5 14.96 22.3 14.38 22V22.03C14.38 24.11 15.86 25.85 17.82 26.24C17.1908 26.4122 16.5301 26.4362 15.89 26.31C16.1616 27.1625 16.6936 27.9084 17.4111 28.4429C18.1285 28.9775 18.9955 29.2737 19.89 29.29C18.3737 30.4904 16.494 31.1393 14.56 31.13C14.22 31.13 13.88 31.11 13.54 31.07C15.44 32.29 17.7 33 20.12 33C28 33 32.33 26.46 32.33 20.79C32.33 20.6 32.33 20.42 32.32 20.23C33.16 19.63 33.88 18.87 34.46 18Z" fill="#213123"/>
</svg>
