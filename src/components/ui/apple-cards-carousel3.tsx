  ...
  return (
    ...
    >
      <div className="relative w-full -mt-24 lg:-mt-36">
        <div className="flex justify-center lg:justify-end gap-2 mr-10">
          <button
            className="relative z-40 h-10 w-10 rounded-full border-primary border-2 flex items-center justify-center disabled:opacity-50"
            onClick={scrollLeft}
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="rounded-3xl bg-gray-100 cursor-default dark:bg-neutral-900 h-80 w-56 md:h-[20rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
