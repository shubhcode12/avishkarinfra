...
const MalharRamgiri: React.FC = () => {
  ...
  // SEO data
  const seoTitle =
    "Malhar Ramgiri - NA Open Plots in Hatkanangale by Avishkar Infra";
  const seoDescription =
    "Invest in premium NA Open Plots at Malhar Ramgiri, Hatkanangale. Ready possession plots with 24-hour water supply, MSEB light, internal tar roads, and separate 7/12 for every plot. Developed by Avishkar Infra.";
  const ogImage =
    "https://www.gruhkhoj.com/media/images/gallery-images/protected-resized-Malharramgariboards003.jpg";
