...
const About = () => {
  ...
  return (
    <div>
      ...
      <section className="w-full bg-[#666666] bg-opacity-20 flex pt-32 pb-24 justify-center px-4 lg:px-0">
        <div className="flex px-8 justify-center w-full">
          <div className=" w-full ">
            <div className="flex flex-col gap-8">
        ...
        <div className="flex justify-center w-full">
          <div className="max-w-6xl w-full">
            <div className="flex flex-col gap-8">
              ...
              Welcome to Avishkar Infra! Best builders and developers in Kolhapur
              </div>
            </div>
...
Our commitment to quality construction is unwavering. We prioritize using top-tier materials and innovative techniques to ensure every project we undertake meets the highest standards of excellence. This dedication has not only enhanced our reputation but also established us as one of the most trusted land developers in Kolhapur.

At Avishkar Infra, we believe in creating spaces that blend convenience with luxury. Our projects are thoughtfully designed to provide amenities that cater to modern lifestyles, ensuring our customers enjoy a comfortable and fulfilling living experience. Whether it&apos;s a premium bungalow or a large-scale development, we focus on every detail to deliver homes that our customers can be proud of.

Our services encompass Design and Build, Construction Management, and the development of Premium Bungalows. Each service is tailored to meet the unique needs of our clients, ensuring a seamless and satisfying experience from concept to completion. Building on a foundation of quality and trust, Avishkar Infra continues to shape the skyline of Kolhapur, transforming visions into reality and setting benchmarks in real estate development. With every project, we strive to exceed expectations and contribute to the city's growth, reinforcing our position as a leader in the industry.
        </div>
          </div>
        </div>
      </section>
